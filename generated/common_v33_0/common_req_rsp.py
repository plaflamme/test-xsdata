...
class BaseCoreReq:
    ...
    :ivar language_code: ISO 639 LanguageCode is used to retrieve
        specific information in the requested language.  Use a 2 or 4
        character language code, example FR or FRFR for French, EN or
        ENGB for English.  The supported providers: ACH, RCH.
    """
