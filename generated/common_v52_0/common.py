...
class AccountCode:
    ...
    :ivar provider_code:
    :ivar supplier_code:
    :ivar type_value: An identifier to categorize this account code. For
...
class BookingSourceType(Enum):
    ...
    :cvar BOOKING_SOURCE_OVERRIDE: The Booking Source Override is
        ...
        of an IATA number. Supported provider(s) : 1P
    """
...
class IncludedInBase:
    ...
    :ivar amount: this attribute shows the amount included in the base
        fare for the specific fee or tax
    """
    class Meta:
        namespace = "http://www.travelport.com/schema/common_v52_0"
...
class PointOfCommencement:
    ...
    :ivar city_or_airport_code: Three digit Airport or City code that
        would be the Point of Commencement location for the trips/legs
        mentioned.
...
class TypeOtasubKey:
    ...
    :ivar name: A subkey to identify the special equipment codes.
        Applicable when Policy/@Name is EQUIP. Uses OTA CODE "EQP". 1P.
...
class TypePolicyCodesList:
    ...
    :ivar policy_code: A code that indicates why an item was determined
        to be ‘out of policy’.
    :ivar min_policy_code: A code that indicates why the minimum fare or
        rate was determined to be ‘out of policy’.
    :ivar max_policy_code: A code that indicates why the maximum fare or
        rate was determined to be ‘out of policy’.
    """
    class Meta:
...
class TypeVendorLocation:
    ...
    :ivar more_rates_token: Enter the Token when provided by hotel
        property, more rates exist. HADS/HSS  support only.
    """
    class Meta:
...
class BookingSource:
    ...
    :ivar type_value: Type of booking source sent in the Code attribute.
        ...
        VehicleCreateReservationReq. 1P.
    """
    class Meta:
        namespace = "http://www.travelport.com/schema/common_v52_0"
...
class LoyaltyProgram:
    """
    :ivar key:
    :ivar supplier_code: The code used to identify the Loyalty supplier,
        e.g. AA, ZE, MC
    :ivar alliance_level:
...
class Ssr:
    ...
    :ivar key:
    :ivar segment_ref: Reference to the air segment. May be required for
        some Types.
    :ivar passive_segment_ref: Reference to the passive segment.
    :ivar provider_reservation_info_ref: Provider reservation reference
        key.
    :ivar type_value: Programmatic SSRs use codes recognized by the
...
class TypeFeeInfo:
    ...
    :ivar text: Additional Information returned from Supplier.(ACH
        only)
    :ivar provider_code:
    :ivar supplier_code:
    :ivar el_stat: This attribute is used to show the action results of
...
class TypeStructuredAddress:
    ...
    :ivar state: The State or Province of address requested, e.g. CA,
        Ontario.
    :ivar postal_code: The 5-15 alphanumeric postal Code for the
        requested address, e.g. 90210.
    :ivar country: The Full country name or two letter ISO country code
        e.g. US, France. A two letter country code is required for a
...
class TypeVoucherInformation:
    ...
    :ivar number: To advise car associates of the voucher number and
        ...
        selected as   "RegularVoucher" for 1P only.
    """
    class Meta:
...
class ServiceData:
    ...
    :ivar emdcoupon_ref: Reference to the corresponding EMD coupon
        issued. Supported providers are 1G/1V/1P
    """
    class Meta:
        namespace = "http://www.travelport.com/schema/common_v52_0"
...
class TypeCreditCardType(TypePaymentCard):
    """
    :ivar extended_payment: Used for American Express (AX) and other
        credit cards, e.g., Visa (VI) and Master card (CA), that allow
        Extended Payment, subject to the BSP market rule.
...
class Guarantee:
    ...
    :ivar type_value: Guarantee, Deposit for 1G/1V/1P and PrePayment for
        1P only
    :ivar key: Key for update/delete of the element
    :ivar reuse_fop: Key of the FOP Key to be reused as this Form of
        Payment.Only Credit and Debit Card will be supported for FOP
...
class ServiceFeeInfo:
    ...
    :ivar payment:
    :ivar status: Status of the service fee. Possible Values – Issued,
