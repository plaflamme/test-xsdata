...
class ClientDataList:
    ...
    :ivar name: The Name that will be associated with the Value.
    :ivar value: The Value that will be associated with the Name.
    """
    class Meta:
        namespace = "http://www.travelport.com/schema/sharedUprofile_v20_0"
...
class MetaDataDelete:
    ...
    :ivar key: The identifier of the element that will be deleted from
        this profile.
    """
    class Meta:
        namespace = "http://www.travelport.com/schema/sharedUprofile_v20_0"
...
class MetaDataDetails:
    ...
    :ivar element_name: Whatever field/element name is triggered here,
        this will do the action on that particular field/element in the
        API database table.
    :ivar type_value: Whatever field/element name is triggered here,
        this will do the action on that particular field/element in the
        API database table.
    :ivar customization: This attribute captures the option for the
        action selected by admin in the UI screen, say Hide or View only
        or Edit.
    :ivar key: This attribute will capture the unique identifier number
...
class MetaData:
    ...
    :ivar meta_data_details:
    :ivar user_type: This attribute will capture which view (say, Agency
        or Traveler) is called for.
    """
    class Meta:
        namespace = "http://www.travelport.com/schema/sharedUprofile_v20_0"
...
@dataclass
class TypeTckeyElement(TypeKeyElement):
    class Meta:
...
@dataclass
class TypeAddress(TypeTckeyElement):
    """
    Profile Address.
...
@dataclass
class TypeElectronicAddress(TypeTckeyElement):
    """
...
@dataclass
class TypePhone(TypeTckeyElement):
    """
...
class MetaDataModifyCmd:
    ...
    meta_data_add: Optional[MetaDataAdd] = field(
        default=None,
        metadata={
            "name": "MetaDataAdd",
            "type": "Element",
    ...
    meta_data_update: Optional[MetaDataUpdate] = field(
        default=None,
        metadata={
            "name": "MetaDataUpdate",
            "type": "Element",
    ...
    meta_data_delete: Optional[MetaDataDelete] = field(
        default=None,
        metadata={
            "name": "MetaDataDelete",
            "type": "Element",
